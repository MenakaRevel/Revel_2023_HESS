...
experiments=["DIR_WSE_E2O_HWEB_001","DIR_WSE_E2O_HWEB_002"\
            ...
            ,"NOM_WSE_E2O_HWEB_003","NOM_WSE_E2O_HWEB_003"]
...
if seaborn_map==False:
    ...
    ax.set_ylabel('$\Delta$ $r$', color='k',fontsize=8)
...
#ax.set_title("BoxPlot NSEAI Rivers",fontsize=9,loc="left")
    ...
    # print (df)
    # print (pd.melt(df))
    ax=sns.boxplot(data=df, fliersize=0.0, palette="Paired", whis=1.5\
    ...
    #     inner="point", bw=0.35, palette="Set2") #x=labels,y=stationlist,
    ...
    for i in np.arange(0,len(labels)):
        ...
        # print (labels[i],"Q1 :",stats[i]['q1'],"Q3 :",stats[i] ['q3'],"Mean :", stats[i]['mean'])
