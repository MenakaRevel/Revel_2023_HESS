...
figname="figs4-discharge_biased_runoff"
#====================================================================
...
def make_fig(station,expname):
    ...
    lines.append(ax1.plot(np.arange(start,last),opn,label="simulated",color="#4dc7ec",linewidth=1.0,alpha=1,zorder=104)[0])
    ...
    xxlist=np.cumsum(np.concatenate(([0],[calendar.monthrange(2019, i)[1] for i in range(1,12)])))
    xxlab=[calendar.month_name[i][:3] for i in range(1,13)]
...
if __name__ == '__main__':
    ...
    # make_fig("3621400","DIR_WSE_ECMWF_HWEB_011")
    make_fig("3620000","DIR_WSE_ECMWF_HWEB_012")