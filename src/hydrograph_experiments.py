...
# pname.append(num)
#====================================================================
def make_fig(station,exp1,exp2,exp3):
    # read data
    ...
    lines.append(ax1.plot(np.arange(start,last),opn1,label="open-loop",color="grey",linewidth=0.8,linestyle="--",alpha=1,zorder=104)[0])
    lines.append(ax1.plot(np.arange(start,last),asm1,label="Direct",color="#D81B60",linewidth=0.3,alpha=1,zorder=106)[0])
    lines.append(ax1.plot(np.arange(start,last),asm2,label="Anomaly",color="#FFC107",linewidth=0.3,alpha=1,zorder=106)[0])
    lines.append(ax1.plot(np.arange(start,last),asm3,label="Normalized",color="#004D40",linewidth=0.3,alpha=1,zorder=106)[0])
    ...
    print ("=======================")
    print (station)
    print ("open-loop", NS(opn1,org))
    print ("dir", NS(asm1,org))
    print ("ano", NS(asm2,org))
    print ("nom", NS(asm3,org))
    ...
    # plt.show()
    plt.savefig("./pptimage/"+station+".pdf",dpi=800,bbox_inches="tight", pad_inches=0.01)
    plt.savefig("./pptimage/"+station+".png",dpi=800,bbox_inches="tight", pad_inches=0.01)
    plt.savefig("./pptimage/"+station+".jpg",dpi=800,bbox_inches="tight", pad_inches=0.01)
    return 0
#============
if __name__ == '__main__':
    # make_fig(station,expname)
    make_fig("3618090","DIR_WSE_E2O_HWEB_001","ANO_WSE_E2O_HWEB_004","NOM_WSE_E2O_HWEB_004")
    make_fig("3627010","DIR_WSE_E2O_HWEB_001","ANO_WSE_E2O_HWEB_004","NOM_WSE_E2O_HWEB_004")
    make_fig("3629001","DIR_WSE_E2O_HWEB_001","ANO_WSE_E2O_HWEB_004","NOM_WSE_E2O_HWEB_004")