...
for i,exp in enumerate(experiments):
    ...
    for line in lines[1::]:
        ...
        if rISS <= 0.0:
            rISS_count=rISS_count+1
        # print (DCOR)
    # metric_frag.append([DCOR_count,NSEAI_count,KGEAI_count,rISS_count])
    metric.append([DCOR_count,NSEAI_count,KGEAI_count,rISS_count])
...
# print experiments
# print metric
df=pd.DataFrame(data=metric, columns=["delat r","NSEAI","KGEAI","rISS"], index=experiments)
print(df)