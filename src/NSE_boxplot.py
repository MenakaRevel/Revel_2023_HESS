...
for i,exp in enumerate(experiments):
    ...
    for line in lines[1::]:
        ...
        NSEasm=NS(asm,org)
        NSEopn=NS(opn,org)
        NSE=NSEasm #-NSEopn)/(1.0-NSEopn+1.0e-20)
        #======================
        metric_frag.append(NSE)
...
if seaborn_map==False:
    ...
    ax.set_ylabel('NSE', color='k',fontsize=8)
...
#ax.set_title("BoxPlot NSEAI Rivers",fontsize=9,loc="left")
    ...
    ax.set_ylabel('$NSE$ $(assimilated)$', color='k',fontsize=12)
    ax.set_xlabel('Experiment', color='k',fontsize=12)
