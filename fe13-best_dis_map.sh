...
figname="fige10-scatter_best_dis"

#*** 0. experiment list
EXLIST="./Fige10-experiment_list.nam"
rm -r $EXLIST
cat >> ${EXLIST} << EOF
...
python src/scatter_best_dis_product.py $syear $eyear $CaMa_dir $mapname $EXLIST $figname $NCPUS &
